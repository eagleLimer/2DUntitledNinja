...
public class PlayerControlSystem extends IteratingSystem {
    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        if(b2body.body.getLinearVelocity().y < -0.04){
            state.set(StateComponent.STATE_FALLING);
        }

        if(b2body.body.getLinearVelocity().y > -0.04 && b2body.body.getLinearVelocity().y <= 0){
        ...
        if(controller.left){
            b2body.body.setLinearVelocity(MathUtils.lerp(b2body.body.getLinearVelocity().x, -4f, 0.2f),b2body.body.getLinearVelocity().y);
        }
        if(controller.right){
            b2body.body.setLinearVelocity(MathUtils.lerp(b2body.body.getLinearVelocity().x, 4f, 0.2f),b2body.body.getLinearVelocity().y);
        }
        ...
        if(controller.up &&
            ...
            b2body.body.applyLinearImpulse(0, 8f, b2body.body.getWorldCenter().x,b2body.body.getWorldCenter().y, true);
