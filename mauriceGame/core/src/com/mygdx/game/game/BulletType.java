...
public enum BulletType {
    PLAYER_BULLET(0.25f,20,2, 0.1f ,TypeComponent.BULLET, ImagesRes.bulletImage), ENEMY_BULLET(0.25f, 10, 100, 0.2f,TypeComponent.BASIC_ENEMY, ImagesRes.bulletImage);
    public float radius;
    public float damage;
    public int type;
